...
import csv
handle = open(file_name, 'r')
file_name = 'InClassExample/Students.txt'
...
print(my_list)
print(my_list[0]['Student_Id'])
print(my_list[0]['First_Name'])
...
print(json_loaded['employees'][1]['name'])
...
handle = open('testingoutput.txt', 'w', newline='')
...
listofcoursetuples = coursesparsetolist('Courses.txt')
print(listofcoursetuples)
listofcoursedicts = coursesparsetodict('Courses.txt')
...
listofstudents = loadxmlet('StudentDetails.xml', 'yes') #Second argument determines whether we want the domestic or the international students.
...
listofstudents = loadxmlet('StudentDetails.xml', 'yes')
cname = input('Please enter a course name such as FIN 462 or MGMT 320:')
my_list = []
for dict in json_loaded['students']:
    id = dict['studentid']
...
listofstudents = loadxmlet('StudentDetails.xml', 'no')
cname = input('Please enter a course name such as FIN 462 or MGMT 320:')
my_list = []
for dict in json_loaded['students']:
    id = dict['studentid']
...
internat = 'yes'
listofstudents = loadxmlet('StudentDetails.xml', internat)
