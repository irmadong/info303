...
answer = input("If python an interpreted language? (reply in yes or no )")
if answer == "yes":
...
while True:
    try:
        ...
        print("It is even" if num/2 is 0 else "It is odd")
        break
    except ValueError:
        print("Please print an interger")
...
#The 1 first input is for the number of machines, which should be either 10 or 20.

# The 2 second input is for units produced per machine per hour.
...
try:
    num_of_machine = int(input("Please enter 10 or 20:"))
    production = int(input("Please enter units produced per machine per hour:"))
    hour = int(input("Please enter the operational time:"))
except:
    print("wrong value ")
if num_of_machine is 10:
    print("the plant has 10 machines operational")
    if num_of_machine*production*hour <=4000:
        print("these 10 machines still have capacity")
    else:
        print("these machines are over capacity")
elif num_of_machine is 20:
    if num_of_machine*production*hour <=800:
        print("these 20 machines still have capacity")
    else:
        print("these machines are over capacity")
else:
    print("Only enter 10 or 20 for number of machines ")
...
stuff = ['red', 24, 98.6] #!!!can contain different data types!!
print(stuff[0])
#including other lists!
stuff = [1, [5, 6], 7, 'blue', ['apple','pear','orange'], [4, 'bill']]
print(stuff[0])
print(stuff[1])
print(stuff[1][0]) #nested lists

#We can loop over the items in a list
my_list = list(range(0,11)) #左闭右开
print(my_list)
print(type(my_list))
mylist = list(range(0,11,2)) #from 0-11, step is 2
print(mylist)
...
print(employees.index('amy',2)) # the index of amy starting from sally
...
del employees
print(employees) #completedly delete employee from the memory
...
# nested tuple
tm_tuple = ('Bill Jones', [1, 7, 9], ([4,3,54], 9, 7))
print(tm_tuple)
tm_tuple[1][0] =54
print(tm_tuple) #can change the list inside tuple!!
tm_tuple[2][0][1] = "Hello Bob"
print(tm_tuple) # immutable inside the list !!
...
tm_tuple = ('welcome to my class',) # create a tuple with only one element
print(type(tm_tuple))
...
#prof
print(testing_tuple[:-7]) #not inclusive!
#mattson
